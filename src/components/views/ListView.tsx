        ...
        {tasks.map((task) => {
          ...
          return (
            <div
              ...
              className={`cursor-pointer rounded-xl border border-border bg-card p-3 transition-colors hover:bg-elevated/40 active:bg-elevated ${isSelected ? "ring-2 ring-accent" : ""}`}
            >
